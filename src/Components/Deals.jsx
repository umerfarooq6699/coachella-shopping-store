...
const Deals = () => {
    ...
    return (
        <>
            <h1 className='text-3xl md:text-5xl ml-3 md:ml-9 lg:ml-[70px] mt-[70px]'>Steal the Deals</h1>
            <p className='ml-3 md:ml-9 lg:ml-[70px] mt-3 text-xl text-gray-500'>Save on all best selling and exclusive styles</p>
            <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-2 w-[90%] mx-auto relative mt-4 md:mt-[40px]'>
                {
                    array.map((e, i) => {
                        return (
                            <>
                                    ...
                                    <div>
                                        <div className='w-full relative group overflow-hidden'>
                                            ...
                                            <img src={e.images[1]} className='w-full absolute top-0 left-0 opacity-0 group-hover:opacity-100 group-hover:scale-110 duration-1000' />
                                                <button onClick={() => Add(e)} className='w-[80%] text-white py-3 rounded absolute left-2/4 -bottom-[50px] -translate-x-2/4 group-hover:bottom-[40px] transition-all duration-400 bg-black hover:bg-[rgb(34,34,34)] hover:text-white'>SELECT OPTIONS</button>
                                            </Link>
                                        ...
                                        <div className='mt-5'>
                                        <h1 className='text-2xl font-[500]'>{e.name}</h1>
